using GoatFarmManagement.Application.Common.Models;
using GoatFarmManagement.Application.TodoItems.Commands.CreateTodoItem;
using GoatFarmManagement.Application.TodoItems.Commands.DeleteTodoItem;
using GoatFarmManagement.Application.TodoItems.Commands.UpdateTodoItem;
using GoatFarmManagement.Application.TodoItems.Commands.UpdateTodoItemDetail;
using GoatFarmManagement.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace GoatFarmManagement.Web.Endpoints;
